<%-- 
    ...
    Created on : 10/09/2018, 04:59:04
    Author     : Idê Moraes
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            ProjetoService serviceProjeto = new ProjetoService();

            id_projeto = Integer.parseInt(request.getParameter("id_projeto"));
            projeto.setId_projeto(id_projeto);
            projeto = serviceProjeto.buscaPorIdProjeto(id_projeto);

        %>

        <div class="container">
            <form name="FormEditar" method="post" action="EditarProjeto" >
                <fieldset>
                    ...
                    <div class="div_texbox">
                        ...
                        <input type="text" name="titulo" id="titulo" value="<%out.print(projeto.getTitulo());%> ">
                    </div>
                    ...
                    <div class="div_texbox">
                        ...
                        <input type="text" name="titulo" id="id_projeto" value="<%out.print(projeto.getId_projeto());%> ">
                    </div>
                ...
                <input type="hidden" name="id_projeto" value="<%out.print(projeto.getId_projeto());%>"/>
            </form>
