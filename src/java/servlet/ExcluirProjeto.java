...
public class ExcluirProjeto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ProjetoService Sproj = new ProjetoService();
            ...
            try {
                Sproj.removeProjeto(projeto);
                response.sendRedirect("listaProjeto.jsp");

            } catch (Exception e) {
                out.println("<h2><script>alert(\">Erro ao remover Projeto! Exclua a Banca Primeiramente\");</script></h2>");
